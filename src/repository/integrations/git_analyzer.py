...
class GitAnalyzer:
    ...
    def run_git_command(self, repo_path: Path, command: list[str]) -> Optional[str]:
    ...
    def get_commit_count(self, repo_path: Path, branch: Optional[str] = None) -> Optional[int]:
    ...
    def get_last_commit_hash(self, repo_path: Path, short: bool = True) -> Optional[str]:
    ...
    def get_last_commit_message(self, repo_path: Path) -> Optional[str]:
    ...
    def get_last_commit_author(self, repo_path: Path) -> Optional[str]:
    ...
    def get_last_commit_date(self, repo_path: Path) -> Optional[str]:
    ...
    def analyze_git_repository(self, repo_path: Path) -> Optional[Dict[str, Any]]:
