...
from ..models.repository_context import DirectoryInfo, AnalysisConfig
...
class DirectoryAnalyzer:
    ...
    def analyze_directory(self, dir_path: Path, root_path: Path) -> Optional[DirectoryInfo]:
    ...
    def get_directory_tree(self, root_path: Path, max_depth: Optional[int] = None) -> dict:
