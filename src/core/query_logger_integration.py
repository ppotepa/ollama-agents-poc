...
def patch_system_with_logging():
    ...
    try:
        # Patch collaborative system
        from src.core.collaborative_system import CollaborativeSystem

        if not hasattr(CollaborativeSystem, '_original_collaborative_execution'):
            CollaborativeSystem._original_collaborative_execution = CollaborativeSystem.collaborative_execution
            ...
            CollaborativeSystem.collaborative_execution = logged_collaborative_execution
            logger.info("✅ Patched CollaborativeSystem with logging")
