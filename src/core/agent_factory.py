...
class DynamicAgentFactory:
    ...
    def __init__(self, models_config_path: Optional[str] = None, streaming: bool = True):
    ...
    def _find_model_config(self, model_id: str) -> Tuple[Optional[str], Optional[Dict[str, Any]]]:
    ...
    def create_agent(self, model_id: str, force_recreate: bool = False) -> Optional[AbstractAgent]:
    ...
    def get_or_create_agent(self, model_id: str) -> Optional[AbstractAgent]:
        """Get existing agent or create new one."""
        return self.create_agent(model_id, force_recreate=False)
    
    def switch_agent(self, current_agent: Optional[AbstractAgent], new_model_id: str) -> Optional[AbstractAgent]:
    ...
    def get_agent_info(self, model_id: str) -> Optional[Dict[str, Any]]:
...
def create_agent_for_model(model_id: str) -> Optional[AbstractAgent]:
