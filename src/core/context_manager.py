...
class ExecutionContext:
    ...
    def add_entry(self, key: str, value: Any, source: str, metadata: Optional[Dict[str, Any]] = None) -> None:
...
class ContextManager:
    ...
    def prepare_model_transition_context(self, session_id: str, 
                                       from_model: str, to_model: str) -> Optional[Dict[str, Any]]:
    ...
    def _load_context(self, session_id: str) -> Optional[ExecutionContext]:
...
def get_context_manager(persistence_dir: Optional[str] = None) -> ContextManager:
